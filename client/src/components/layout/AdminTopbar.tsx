      ...
      <div className="flex items-center gap-4 flex-1">
        ...
        <div className="relative max-w-md flex-1 hidden sm:block">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-xl text-sm text-white placeholder-white/25 focus:outline-none transition-all duration-200"
            style={{
          ...
          />
          <kbd
            className="absolute right-3 top-1/2 -translate-y-1/2 px-1.5 py-0.5 text-[10px] text-white/20 rounded border border-white/[0.08]"
