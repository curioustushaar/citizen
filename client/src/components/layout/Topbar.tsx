...
export default function Topbar({ onMenuToggle }: TopbarProps) {
  ...
  return (
    <header className="h-16 flex items-center justify-between px-4 lg:px-6 border-b border-white/[0.06] bg-surface-900/60 backdrop-blur-xl sticky top-0 z-40 premium-topbar">
      {/* Left: Menu + Search */}
            ...
            <>
              ...
              >
                ...
                <div className="hidden md:block text-left">
                  ...
                  <p className="text-[10px] text-white/30 uppercase tracking-widest leading-none">{roleLabels[user.role]}</p>
                </div>
